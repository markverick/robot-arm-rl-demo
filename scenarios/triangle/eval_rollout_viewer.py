...
MODEL_PREFIX = "ppo_triangle_panda"
...
def draw_ee_trail(viewer, points, radius=0.004):
    ...
    for i in range(n):
        ...
        rgba = np.array([1.00, 0.45, 0.20, alpha], dtype=np.float32)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Rollout viewer for triangle scenario")
